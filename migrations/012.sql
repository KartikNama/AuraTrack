...
CREATE POLICY "Users can view their own activity logs"
  ...
  USING (
    EXISTS (
      ...
      JOIN public.time_entries ON screenshots.time_entry_id = time_entries.id
...
CREATE INDEX IF NOT EXISTS activity_logs_screenshot_id_idx ON public.activity_logs(screenshot_id);